                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label for="role_id"
                                                    ...
                                                    @if($roles)
                                                        ...
                                                        @endforeach
                                                    @endif
                                                    <!-- <option value="1" @if(isset($employee)){{ ($employee->user_role->role_id) == '1' ? 'selected':'' }}
                                                        @elseif (old('role_id') == '1' ) selected
                                                        @endif
                                                    >Manager</option>
                                                    <option value="2"  @if(isset($employee)){{ ($employee->user_role->role_id) == '2' ? 'selected':'' }}
                                                        @elseif (old('role_id') == '2' ) selected
                                                        @endif
                                                    > Booking Person</option>
                                                    <option value="3"  @if(isset($employee)){{ ($employee->user_role->role_id) == '3' ? 'selected':'' }}
                                                        @elseif (old('role_id') == '3' ) selected
                                                        @endif
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input id="mobile_number" type="text"
                                                       class="number_field form-control @error('mobile_number') is-invalid @enderror"
                                                       name="mobile_number"
                                        ...
                                        <div class="col-4">
                                            ...
                                            @if(isset($employee->avatar))
                                                <img src="{{ asset('storage/uploads/employees/photo/'.$employee->avatar) }}" alt=""  width="100" />
                                                @endif
                                        </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            @if(isset($employee->doc_proof))
                                            <img src="{{ asset('storage/uploads/employees/idproof/'.$employee->doc_proof) }}" alt=""  width="100" />
                                            @endif
                                        </div>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="username" type="text"
                                                       ...
                                                       name="username"
                                                       value="@if(isset($employee)){{$employee->username}}@else{{ old('username') }}@endif" readonly required>
                                        ...
                                        <input type="hidden" name='old_doc_proof' value="{{$employee->doc_proof}}"/>
    ...
    $('#office_id').select2({
        ...
        $(document).ready(function() {
                ...
                $('#office_type').change(function(){
                      ...
                      $('#office_id option:selected').val('');
                      $('#office_id option:selected').text('Choose Office Code');
