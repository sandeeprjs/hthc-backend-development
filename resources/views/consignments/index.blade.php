...
{{--                <div class="mr-2 mb-2">--}}
    ...
    {{--                            <option value="{{ request()->input('office_id') }}">{{ request()->input('office_id') }}</option>--}}
    {{--                        @endif--}}
                        </select>
                        @error('office_id')
                ...
                <table class="table table-bordered">
                    ...
                    @foreach($consignments as $consignment)
                        <tr>
                            ...
                            @if(request()->input('consg_number'))
                                <td>{{ $consignment->minConsgNum }}</td>
                            @else
                            ...
                            <button onclick="window.open('{{ route('consignments.export', $consignment->batch_id) }}', '_blank')"  class="btn btn-sm "><img src="https://img.icons8.com/windows/32/000000/export-excel.png"/></i></button>
