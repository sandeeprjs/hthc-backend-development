    ...
    <div class="container">
        ...
        <div class="sb-page-header-content py-5">
            <div class="d-flex justify-content-between">
                <div>
                    <h1 class="sb-page-header-title"><span>Bulk Booking</span></h1>
                </div>
                {{--                <div>--}}
                ...
                @endif
        <form method="POST" action="{{ route('bookings.import') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                    ...
                    <div class="col-8 form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="consgType" disabled class="form-control" name="consg_type">
                                {{--                        <option value="" selected class="form-control">Select a type</option>--}}
                                <option value="dox" selected>{{ 'Dox' }}</option>
                    ...
                    <div class="row">
                            ...
                            <div class="booking-card pb-2">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select autocapitalize="on" id="customer_id" data-tags="true" required name="customer_id" class="form-control @error('customer_id') is-invalid @enderror">
                                            @if(old('customer_id'))
                                                <option autocapitalize="on" class="text-capitalize" value="{{ old('customer_id') }}">{{ old('customer_id') }}</option>
                                            @endif
                                        </select>
                                        @error('customer_id')
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="sender_pincode_id" name="sender_pincode_id" required class="form-control @error('sender_pincode_id') is-invalid @enderror">
                                            @if(old('sender_pincode_id'))
                                                <option value="{{ old('sender_pincode_id') }}">{{ old('sender_pincode_id') }}</option>
                                            @endif
                                        </select>
                        ...
                        <div class="col-12 mt-4" >
                            <div class="booking-card pb-5">
                                ...
                                <div class="pb-2">Please upload the customer information in Excel<span class="text-danger">*</span></div>
                                ...
                                <div class="custom-file pb-3 d-block">
                                    ...
                                    <span class="float-right mx-sm-2"><a href="{{ route('download-bb-sample') }}">Download sample file <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></span>
                                </div>
...
{{--                                @enderror--}}
{{--                            </section>--}}
                            <section id="sec-weight" class="form-group col-md-4">
                                <label>{{ 'Capt. Weight/Consignment' }}<span class="text-danger">*</span></label>
...
{{--                            </section>--}}
                        ...
                        <div class="form-row vol-card mb-4">
                            ...
                            <section class="form-group pl-2">
                                <label>{{'Booked Amount/Consignment'}}<span class="text-danger">*</span></label>
                            ...
                            @if($user['office_type'] != 'FR')
                                <section class="form-group pl-2" style="padding-top: 32px !important;">
                                    <label class="invisible">label</label>
                                    <input type="checkbox" id="book_for_partner" name="book_for_partner" class="form-check-input " value="1">
                                    <label for="book_for_partner" class="form-check-label ">{{ 'Book for a Partner' }}</label>
                                </section>


                                <section class="form-group pl-2" id="partnerSelect" style="display: none;">
                                    <label class="invisible w-100" >label</label>
                            ...
                            <section class="form-group">
                                <label class="invisible">{{'Declared Value/Consignment'}}</label>
...
{{--                        </div>--}}
            ...
            <div class="row mb-5 pb-5">
                ...
                <div class="col-8 mx-auto text-center">
                    <div class="w-50 mx-auto">
                        <button type="submit" class="mx-auto btn-lg btn btn-primary">{{ 'Continue and validate data' }}</button>
                    </div>
    ...
    <script>
        ...
        $('#book_for_partner').on('click', function () {
            let secPartner = $("#partnerSelect");
            if ($(this).prop('checked')) {
                secPartner.show();
            } else {
                secPartner.hide()
