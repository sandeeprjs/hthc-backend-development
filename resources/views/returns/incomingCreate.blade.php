...
<div class="container">
        <div class="sb-page-header-content py-5">
            <div class="d-flex justify-content-between">
                <div>
                    <h1 class="sb-page-header-title"><span> Returns Incoming</span></h1>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="">
                    ...
                    @endif
                    <form action="{{ route('returns.store') }}" method="POST" id="incoming_manifest">
                        @csrf
                        ...
                        <div class="row">
                           ...
                           <!--- <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <input type="hidden" id="manifest_type" name="manifest_type" value="RI" />
                    ...
                    jQuery.ajax({
                            ...
                            success: function(result){
                                ...
                                if(result.status == "failed"){
                                    ...
                                    $('#manifest_number').val('');
                                   // $('#manifest_number').prop('required',true);
