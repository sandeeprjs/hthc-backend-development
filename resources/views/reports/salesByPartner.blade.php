...
@section('content')
    <div class="container">
        <div class="sb-page-header-content py-5">
            <div class="d-flex justify-content-between">
                <div>
                    <h1 class="sb-page-header-title"><span>Sales By Partner Report</span></h1>
                </div>
    ...
    <div class="row m-0 partner-report">
        <div class="col-12">
            <div class="container">
            <form class="form-inline" action="{{ route('salesByPartner.report') }}">
                <div class="row w-100">
                    <div class="col ">
                    ...
                    <div class="col">
                        <select id="fr_id" style="width: 100%" name="fr_id" class="form-control @error('fr_id') is-invalid @enderror">
                ...
                <div class="row mt-2">
                    <div class="col p-0">
                        ...
                        <a href="{{ route('salesByPartner.report') }}"
                           class="btn  mx-sm-1 btn-light btn-outline-seconndary">{{ 'Reset' }}</a>
                        <button type="submit" class="btn btn-primary mx-sm-2 " name="btnSubmit"
                    ...
                    <table class="table">
                        ...
                        @foreach($bookings as $booking)
                            ...
                            <tr>
                                ...
                                <td>{{ $booking->BookingFranchisee ?? '' }}</td>
